...
class Profile extends Component {
              ...
              <Col md={6} sm={12}>
                ...
                <Row>
                  <Col lg={4} md={12}>
                    ...
                    >
                      <option defaultValue value={fields.country}>
                        {fields.country}
                      </option>
  ...
  submit = async () => {
    ...
    const { success, message, errors } = await profileService.ChangeProfile(
      formData
    );
  ...
  resetPassword = async () => {
    ...
    const { success, message, errors } = await profileService.resetPassword({
