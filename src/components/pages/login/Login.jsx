...
class Login extends Component {
                        ...
                        <Row>
                            <Col md={6}>
                                ...
                                <InputGroup className="mb-3 flex input-group1">
                                    ...
                                    />
                                    <i onClick={() => this.setState({ openEyes: !openEyes })} className={openEyes ? "fa fa-eye-slash fa-1x" : "fa fa-eye fa-1x"}></i>
                                </InputGroup>
                        ...
                        <div className="address-inputs">
                            <Row>
                                <Col lg={12} md={12} sm={12} style={{ marginBottom: "1rem" }}>
                                    <TextInput name="checkEmail" label="Email" placeholder="Email" value={fields.checkEmail} onFieldChange={onFieldChange} validate={errors.checkEmail} />
                                </Col>
    ...
    checkEmail = async () => {
        const { fields } = this.state;
        const { success, data, message, errors } = await profileService.checkEmail({
        ...
        displayAlert("Done", "Check your Email", "success").then(() => this.closeModal());
    };
}
