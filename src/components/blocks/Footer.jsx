...
function Footer() {
    ...
    return pageLoader ? (
        ...
        <>
                        ...
                        <Col md={4}>
                            <div className="footer__mid">
                                ...
                                <ul>
                                    ...
                                    {footerData?.pages?.map(({ title, machine_name }) => {
                                        return (
                                            <li>
            ...
            <Modal show={modal} width="600" effect="fadeInUp" onHide={closeModal} className="location-modal footer__branch-data-modal">
